...
public class PacketContainer extends AbstractStructure implements Serializable {
	...
	private static final ConcurrentMap<Class<?>, Method> writeMethods = Maps.newConcurrentMap();
	private static final ConcurrentMap<Class<?>, Method> readMethods = Maps.newConcurrentMap();
